...
* Detection of Weak Granulars in Large Panels (with [Yinfeng Zeng](https://www.econ.cam.ac.uk/people/postgraduates/yinfeng-zeng))
    ...
    <summary>Abstract</summary>
    <p>
    This paper presents a general framework for semiparametric tensor factor models. The proposed model assumes that the factor loadings consist of a nonparametric component, which is an unknown function of auxiliary time-varying covariates, and an orthogonal component that is independent of these covariates. We propose an estimation method named Higher-Order Projected SVD (HOP-SVD). Its theoretical properties are explored and demonstrated through simulated and empirical examples.
    </p>
    </details>
